...
//		new String을 사용하면 동일한 문자열을 사용했더라도 메모리주소를 따로 사용함
...
//		substring : 지정한 문자열에서 문자를 지정한 만큼 잘라내서 반환, 매개변수가 1개일 경우 지정한 index에서 끝까지, 
//		2개일 경우 첫번째 매개변수는 index, 두번째 매개변수를  끝까지 가져올 수 있다
